# Operator Quickstart — Community Tour Operator Operations

Shortest path from clone to a verified local dry-run for **ISIC 7912** (`cloud-itonami-isic-7912`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7912.git
cd cloud-itonami-isic-7912
```
...
- Blueprint governor key: `tour-operator-governor`
- Likely source path: `src/**/tour-operator-governor.cljc`
